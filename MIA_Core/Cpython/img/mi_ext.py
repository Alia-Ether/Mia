# img/mi_ext.py
# ╔════════════════════════════════════════════════════════════════╗
# ║  Project: MIA Core - MI_EXT Image Handler                     ║
...
def print_info(image_name, _mia_output=None):
    ...
    data = read_file_chunk(image_name, offset=0, size=8192)
    ...
    if RICH_AVAILABLE:
        ...
        table.add_row("Type", "Xiaomi Extended Partition")
        if avb_info:
        ...
        console.print(
            Panel("[yellow]📌 NOTE[/yellow]\n\nMI_EXT contains Xiaomi-specific customizations.", border_style="yellow"))
    else:
